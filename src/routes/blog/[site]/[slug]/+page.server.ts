...
export const load: PageServerLoad = async ({ params, parent }) => {
  ...
  return {
    article: {
      slug: article.slug, title: article.title, metaTitle: article.metaTitle,
      metaDescription: article.metaDescription, cover: article.coverImage,
      html: renderArticleHtml(article.bodyMd), publishedAt: article.publishedAt,
