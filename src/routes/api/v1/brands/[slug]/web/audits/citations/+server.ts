...
import { LIST_AUDIT_CITATIONS_READ } from '@anomalia/api-contracts';
...
export const GET: RequestHandler = async ({ request, params, url }) => {
  ...
  const parsed = LIST_AUDIT_CITATIONS_READ.input.safeParse(Object.fromEntries(url.searchParams));
  if (!parsed.success) {
