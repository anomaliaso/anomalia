...
const LEGACY_STRAYS = [
  '--background src/lib/components/ChatAgentProposalCard.svelte',
  '--background src/lib/components/ChatSessionMemory.svelte',
  ...
  '--border src/lib/components/ChatAgentProposalCard.svelte',
  '--border src/lib/components/ChatSessionMemory.svelte',
  ...
  '--danger src/lib/components/ChatPrompt.svelte',
  ...
  '--destructive src/lib/components/ChatSessionMemory.svelte',
  '--foreground src/lib/components/ChatAgentProposalCard.svelte',
  '--foreground src/lib/components/ChatSessionMemory.svelte',
  ...
  '--muted src/lib/components/ChatAgentProposalCard.svelte',
  '--muted src/lib/components/ChatSessionMemory.svelte',
  ...
  '--muted-foreground src/lib/components/ChatAgentProposalCard.svelte',
  '--muted-foreground src/lib/components/ChatSessionMemory.svelte',
  '--panel src/lib/components/AdsOverview.svelte',
  '--sidebar-accent src/lib/components/OnboardingChecklist.svelte',
  '--sidebar-border src/lib/components/OnboardingChecklist.svelte',
  ...
  '--sidebar-foreground src/lib/components/OnboardingChecklist.svelte',
