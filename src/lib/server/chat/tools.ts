...
import type { AnyRec, ChatToolCtx } from './tools/shared';
import { readTools } from './tools/read-tools';
import { integrationTools } from './tools/integration-tools';
import { brandWriteTools } from './tools/brand-write-tools';
import { catalogTools } from './tools/catalog-tools';
import { pipelineTools } from './tools/pipeline-tools';
import { createContentTools } from './tools/create-content-tools';
import { expressionMemoryTools } from './tools/expression-memory-tools';
...
import { createNotifyTools } from '$lib/server/chat/notify-tools';
import { createNotificationTools } from '$lib/server/chat/notification-tools';
import { createOnboardingTools } from '$lib/server/chat/onboarding-tools';
...
import { createAttachmentTools } from '$lib/server/chat/attachment-tools';
import { createGraphicSourceEditTools } from '$lib/server/chat/graphic-source-edit';
import { createMotionVideoChatTools } from '$lib/server/chat/motion-video-tools';
  ...
  return {
    ...
    ...createGraphicSourceEditTools(
      async ({ post_id }) => {
        ...
        const { loadEditorContext } = await import('$lib/server/chat/post-editor-tools');
