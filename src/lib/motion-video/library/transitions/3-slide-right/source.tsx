// wow: SLIDE_INERTIA — slide da DESTRA. La presentazione `slide` di Remotion muove entrambe le
...
export default function SlideRightDemo() {
	const { fps } = useVideoConfig();
	return (
		<AbsoluteFill style={{ backgroundColor: '#0B0B0F' }}>
			<TransitionSeries>
				<TransitionSeries.Sequence durationInFrames={Math.round(BEAT * fps)}>
					<Panel bg="#0B0B0F" word="PRIMA" caption="slide · from-right" delay={0} />
