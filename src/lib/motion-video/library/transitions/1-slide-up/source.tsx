// wow: SLIDE_INERTIA — slide dal BASSO. La presentazione `slide` di Remotion muove entrambe le
// scene (l'uscente continua a salire mentre l'entrante arriva): l'overlap È la transizione.
		...
		<AbsoluteFill style={{ backgroundColor: '#0B0B0F' }}>
			<TransitionSeries>
				<TransitionSeries.Sequence durationInFrames={Math.round(BEAT * fps)}>
					<Panel bg="#0B0B0F" word="PRIMA" caption="slide · from-bottom" delay={0} />
