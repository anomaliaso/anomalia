...
export const MCP_INSTRUCTIONS = [
  'Anomalia runs social brands: posts, editorial plans, media, brand knowledge, SEO, blog.',
  'Most tools act on ONE brand and need its `slug`; `list_brands` is where slugs come from. When you do not know which brand, ASK — never pick one yourself: guessing spends a real organisation’s credits and writes into a real client’s library.',
  ...
  'Retired into `query`: `list_articles`, `list_ideas`, `get_memory`, `get_appearance`; the skill names table and filter.',
